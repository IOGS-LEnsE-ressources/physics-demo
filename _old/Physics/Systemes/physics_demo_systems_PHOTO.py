...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Photodetection System - Simulation")
        ...
        self.simu = gL.systemSimulation()
        self.phDsys = gL.photodetection()
    ...
    def updateModel(self):
        ...
        samplesF = 1001
        freqMax = gL.higherPowerOfK(self.phDsys.AOP.getGBW(), 10) + 2
